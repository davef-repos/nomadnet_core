...
class Conversation:
    ...
    def received_announce(destination_hash, announced_identity, app_data):
        ...
        app = NomadNetworkApp.get_shared_instance()
    ...
    def load(self):
        try:
            ...
            if self.lxm.state > LXMF.LXMessage.GENERATING and self.lxm.state < LXMF.LXMessage.SENT:
                ...
                from nomadnet_core.core.NomadNetworkApp import NomadNetworkApp as _NomadApp
                for pending in _NomadApp.get_shared_instance().message_router.pending_outbound:
                    if pending.hash == self.lxm.hash:
                        found = True

                for pending_id in _NomadApp.get_shared_instance().message_router.pending_deferred_stamps:
            ...
            try:
                from nomadnet_core.core.NomadNetworkApp import NomadNetworkApp as _NomadApp
                app = _NomadApp.get_shared_instance()
